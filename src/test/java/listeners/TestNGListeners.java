...
import pomTestCasePages.BaseTest;
import utilities.TakeScreeenshot;
...
//			ScreenShot.captureScreenShot(driver, result.getMethod().getMethodName());
		test.addScreencastFromPath(TakeScreeenshot.captureScreenShotWithPath(driver, result.getName()));
